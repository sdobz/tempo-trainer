...
Deno.test(
  "AudioContextManager: ensureContext transitions to ready",
  async () => {
...
Deno.test(
  "AudioContextManager: device inventory and selection are state",
  async () => {
    const originalAudioContext = globalThis.AudioContext;
    const originalNavigator = globalThis.navigator;
...
Deno.test(
  "AudioContextManager: start and stop transition input lifecycle",
  async () => {
    const originalAudioContext = globalThis.AudioContext;
    const originalNavigator = globalThis.navigator;
