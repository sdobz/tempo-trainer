...
Deno.test("OnboardingPane: should have required template and style URLs", async () => {
  const component = await createComponent();
...
Deno.test("OnboardingPane: should merge state updates, not replace", async () => {
  const component = await createComponent();
...
Deno.test("OnboardingPane: should call onStateChange hook when state updates", async () => {
  const component = await createComponent();
...
Deno.test("OnboardingPane: setState should throw on invalid argument", async () => {
  const component = await createComponent();
  try {
...
Deno.test("OnboardingPane: setState should accept valid state objects", async () => {
  const component = await createComponent();
  component.setState({});
  assertEquals(component.state.micConfigured, false);
